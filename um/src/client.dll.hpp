...
namespace cs2_dumper {
    namespace schemas {
        ...
        namespace client_dll {
            ...
            // NetworkVarNames: m_ConfigEntitiesToPropagateMaterialDecalsTo
            ...
            namespace C_BaseModelEntity {
                ...
                constexpr std::ptrdiff_t m_vecRenderAttributes =
                    0xA88;  // C_UtlVectorEmbeddedNetworkVar<EntityRenderAttribute_t>
                ...
                constexpr std::ptrdiff_t m_ConfigEntitiesToPropagateMaterialDecalsTo =
                    0xC40;  // C_NetworkUtlVectorBase<CHandle<C_BaseModelEntity>>
            ...
            namespace C_PointClientUIHUD {
                ...
                constexpr std::ptrdiff_t m_vecCSSClasses =
                    0xEC0;  // C_NetworkUtlVectorBase<CUtlSymbolLarge>
            }               // namespace C_PointClientUIHUD
            ...
            namespace C_BaseCombatCharacter {
                constexpr std::ptrdiff_t m_hMyWearables =
                    0x1070;  // C_NetworkUtlVectorBase<CHandle<C_EconWearable>>
                ...
                constexpr std::ptrdiff_t m_nWaterWakeMode =
                    0x1090;  // C_BaseCombatCharacter::WaterWakeMode_t
            ...
            namespace C_SceneEntity {
                ...
                constexpr std::ptrdiff_t m_hActorList =
                    0x568;  // C_NetworkUtlVectorBase<CHandle<C_BaseFlex>>
                constexpr std::ptrdiff_t m_bWasPlaying = 0x580;  // bool
                constexpr std::ptrdiff_t m_QueuedEvents =
                    0x590;  // CUtlVector<C_SceneEntity::QueuedEvents_t>
            ...
            namespace CPlayer_CameraServices {
                ...
                constexpr std::ptrdiff_t m_hColorCorrectionCtrl =
                    0x98;                                       // CHandle<C_ColorCorrection>
                constexpr std::ptrdiff_t m_hViewEntity = 0x9C;  // CHandle<C_BaseEntity>
                constexpr std::ptrdiff_t m_hTonemapController =
                    0xA0;                                 // CHandle<C_TonemapController2>
                constexpr std::ptrdiff_t m_audio = 0xA8;  // audioparams_t
                constexpr std::ptrdiff_t m_PostProcessingVolumes =
                    0x120;  // C_NetworkUtlVectorBase<CHandle<C_PostProcessingVolume>>
                ...
                constexpr std::ptrdiff_t m_hActivePostProcessingVolume =
                    0x1F4;  // CHandle<C_PostProcessingVolume>
            ...
            namespace C_BaseCSGrenade {
                ...
                constexpr std::ptrdiff_t m_hSwitchToWeaponAfterThrow =
                    0x1AA8;  // CHandle<C_CSWeaponBase>
            }                // namespace C_BaseCSGrenade
            // Parent: C_FuncBrush
            // Fields count: 8
            //
            ...
            namespace CSkeletonInstance {
                ...
                constexpr std::ptrdiff_t m_bIsGeneratingLatchedParentSpaceState =
                    0x0;                                           // bitfield:1
            ...
            namespace C_CSPlayerPawn {
                ...
                constexpr std::ptrdiff_t m_pActionTrackingServices =
                    0x1490;  // CCSPlayer_ActionTrackingServices*
                ...
                constexpr std::ptrdiff_t m_vecBulletHitModels =
                    0x2208;                                      // CUtlVector<C_BulletHitModel*>
                ...
                constexpr std::ptrdiff_t m_iBlockingUseActionInProgress =
                    0x2294;                                           // CSPlayerBlockingUseAction_t
            ...
            namespace C_BaseCSGrenadeProjectile {
                ...
                constexpr std::ptrdiff_t m_nExplodeEffectIndex =
                    0x10E0;  // CStrongHandle<InfoForResourceTypeIParticleSystemDefinition>
                ...
                constexpr std::ptrdiff_t m_nSnapshotTrajectoryEffectIndex =
                    0x1110;  // ParticleIndex_t
                constexpr std::ptrdiff_t m_hSnapshotTrajectoryParticleSnapshot =
                    0x1118;  // CStrongHandle<InfoForResourceTypeIParticleSnapshot>
                constexpr std::ptrdiff_t m_arrTrajectoryTrailPoints = 0x1120;  // CUtlVector<Vector>
                constexpr std::ptrdiff_t m_arrTrajectoryTrailPointCreationTimes =
                    0x1138;  // CUtlVector<float32>
            ...
            namespace CEffectData {
                ...
                constexpr std::ptrdiff_t m_nEffectIndex =
                    0x50;  // CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>
            ...
            namespace C_PointClientUIWorldPanel {
                ...
                constexpr std::ptrdiff_t m_pOffScreenIndicator =
                    0xEB0;                                        // CPointOffScreenIndicatorUi*
                ...
                constexpr std::ptrdiff_t m_vecCSSClasses =
                    0xF08;  // C_NetworkUtlVectorBase<CUtlSymbolLarge>
            ...
            namespace C_Team {
                constexpr std::ptrdiff_t m_aPlayerControllers =
                    0x550;  // C_NetworkUtlVectorBase<CHandle<CBasePlayerController>>
                constexpr std::ptrdiff_t m_aPlayers =
                    0x568;  // C_NetworkUtlVectorBase<CHandle<C_BasePlayerPawn>>
            ...
            namespace C_TextureBasedAnimatable {
                ...
                constexpr std::ptrdiff_t m_hPositionKeys =
                    0xCD8;  // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_hRotationKeys =
                    0xCE0;  // CStrongHandle<InfoForResourceTypeCTextureBase>
            ...
            // NetworkVarNames: m_vecServerAuthoritativeWeaponSlots
            ...
            namespace C_CSGOViewModel {
                ...
                constexpr std::ptrdiff_t m_nLastKnownAssociatedWeaponEntIndex =
                    0xF7C;                                                        // CEntityIndex
            ...
            namespace C_EnvLightProbeVolume {
                constexpr std::ptrdiff_t m_hLightProbeTexture =
                    0x1528;  // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_hLightProbeDirectLightIndicesTexture =
                    0x1530;  // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_hLightProbeDirectLightScalarsTexture =
                    0x1538;  // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_hLightProbeDirectLightShadowsTexture =
                    0x1540;  // CStrongHandle<InfoForResourceTypeCTextureBase>
            ...
            namespace C_CSPlayerPawnBase {
                ...
                constexpr std::ptrdiff_t m_pViewModelServices =
                    0x12C0;  // CPlayer_ViewModelServices*
                ...
                constexpr std::ptrdiff_t m_hOriginalController =
                    0x1460;  // CHandle<CCSPlayerController>
            }                // namespace C_CSPlayerPawnBase
            ...
            namespace C_PostProcessingVolume {
                constexpr std::ptrdiff_t m_hPostSettings =
                    0xCE8;  // CStrongHandle<InfoForResourceTypeCPostProcessingResource>
            ...
            namespace CBasePlayerController {
                ...
                constexpr std::ptrdiff_t m_hSplitScreenPlayers =
                    0x618;  // CUtlVector<CHandle<CBasePlayerController>>
            ...
            namespace CBaseAnimGraphController {
                constexpr std::ptrdiff_t m_animGraphNetworkedVars =
                    0x18;  // CAnimGraphNetworkedVariables
            ...
            namespace C_PathParticleRope {
                ...
                constexpr std::ptrdiff_t m_iEffectIndex =
                    0x590;  // CStrongHandle<InfoForResourceTypeIParticleSystemDefinition>
                constexpr std::ptrdiff_t m_PathNodes_Position =
                    0x598;  // C_NetworkUtlVectorBase<Vector>
                constexpr std::ptrdiff_t m_PathNodes_TangentIn =
                    0x5B0;  // C_NetworkUtlVectorBase<Vector>
                constexpr std::ptrdiff_t m_PathNodes_TangentOut =
                    0x5C8;  // C_NetworkUtlVectorBase<Vector>
                constexpr std::ptrdiff_t m_PathNodes_Color =
                    0x5E0;  // C_NetworkUtlVectorBase<Vector>
                constexpr std::ptrdiff_t m_PathNodes_PinEnabled =
                    0x5F8;  // C_NetworkUtlVectorBase<bool>
                constexpr std::ptrdiff_t m_PathNodes_RadiusScale =
                    0x610;  // C_NetworkUtlVectorBase<float32>
            }               // namespace C_PathParticleRope
            // Parent: C_CSWeaponBaseGun
            // Fields count: 0
            ...
            namespace CBasePlayerWeaponVData {
                constexpr std::ptrdiff_t m_szWorldModel =
                ...
                constexpr std::ptrdiff_t m_szMuzzleFlashParticle =
                ...
                constexpr std::ptrdiff_t m_aShootSounds =
                    0x220;                                 // CUtlMap<WeaponSound_t,CSoundEventName>
            ...
            namespace C_BasePlayerPawn {
                ...
                constexpr std::ptrdiff_t m_pFlashlightServices =
                ...
                constexpr std::ptrdiff_t m_ServerViewAngleChanges =
                    0x1150;  // C_UtlVectorEmbeddedNetworkVar<ViewAngleServerChange_t>
            ...
            namespace CAttributeManager {
                ...
                constexpr std::ptrdiff_t m_CachedResults =
                    0x30;  // CUtlVector<CAttributeManager::cached_attribute_float_t>
            }              // namespace CAttributeManager
            // Parent: C_BaseEntity
            // Fields count: 0
            ...
            namespace CAnimGraphNetworkedVariables {
                constexpr std::ptrdiff_t m_PredNetBoolVariables =
                    0x8;  // C_NetworkUtlVectorBase<uint32>
                constexpr std::ptrdiff_t m_PredNetByteVariables =
                    0x20;  // C_NetworkUtlVectorBase<uint8>
                constexpr std::ptrdiff_t m_PredNetUInt16Variables =
                    0x38;  // C_NetworkUtlVectorBase<uint16>
                constexpr std::ptrdiff_t m_PredNetIntVariables =
                    0x50;  // C_NetworkUtlVectorBase<int32>
                constexpr std::ptrdiff_t m_PredNetUInt32Variables =
                    0x68;  // C_NetworkUtlVectorBase<uint32>
                constexpr std::ptrdiff_t m_PredNetUInt64Variables =
                    0x80;  // C_NetworkUtlVectorBase<uint64>
                constexpr std::ptrdiff_t m_PredNetFloatVariables =
                    0x98;  // C_NetworkUtlVectorBase<float32>
                constexpr std::ptrdiff_t m_PredNetVectorVariables =
                    0xB0;  // C_NetworkUtlVectorBase<Vector>
                constexpr std::ptrdiff_t m_PredNetQuaternionVariables =
                    0xC8;  // C_NetworkUtlVectorBase<Quaternion>
                constexpr std::ptrdiff_t m_PredNetGlobalSymbolVariables =
                    0xE0;  // C_NetworkUtlVectorBase<CGlobalSymbol>
                constexpr std::ptrdiff_t m_OwnerOnlyPredNetBoolVariables =
                    0xF8;  // C_NetworkUtlVectorBase<uint32>
                constexpr std::ptrdiff_t m_OwnerOnlyPredNetByteVariables =
                    0x110;  // C_NetworkUtlVectorBase<uint8>
                constexpr std::ptrdiff_t m_OwnerOnlyPredNetUInt16Variables =
                    0x128;  // C_NetworkUtlVectorBase<uint16>
                constexpr std::ptrdiff_t m_OwnerOnlyPredNetIntVariables =
                    0x140;  // C_NetworkUtlVectorBase<int32>
                constexpr std::ptrdiff_t m_OwnerOnlyPredNetUInt32Variables =
                    0x158;  // C_NetworkUtlVectorBase<uint32>
                constexpr std::ptrdiff_t m_OwnerOnlyPredNetUInt64Variables =
                    0x170;  // C_NetworkUtlVectorBase<uint64>
                constexpr std::ptrdiff_t m_OwnerOnlyPredNetFloatVariables =
                    0x188;  // C_NetworkUtlVectorBase<float32>
                constexpr std::ptrdiff_t m_OwnerOnlyPredNetVectorVariables =
                    0x1A0;  // C_NetworkUtlVectorBase<Vector>
                constexpr std::ptrdiff_t m_OwnerOnlyPredNetQuaternionVariables =
                    0x1B8;  // C_NetworkUtlVectorBase<Quaternion>
                constexpr std::ptrdiff_t m_OwnerOnlyPredNetGlobalSymbolVariables =
                    0x1D0;  // C_NetworkUtlVectorBase<CGlobalSymbol>
            ...
            namespace C_RopeKeyframe {
                ...
                constexpr std::ptrdiff_t m_iRopeMaterialModelIndex =
                    0xD18;  // CStrongHandle<InfoForResourceTypeIMaterial2>
                ...
                constexpr std::ptrdiff_t m_PhysicsDelegate =
                    0x1028;  // C_RopeKeyframe::CPhysicsDelegate
                constexpr std::ptrdiff_t m_hMaterial =
                    0x1038;  // CStrongHandle<InfoForResourceTypeIMaterial2>
            ...
            namespace C_GradientFog {
                constexpr std::ptrdiff_t m_hGradientFogTexture =
                    0x550;  // CStrongHandle<InfoForResourceTypeCTextureBase>
            ...
            namespace C_EnvCombinedLightProbeVolume {
                ...
                constexpr std::ptrdiff_t m_hCubemapTexture =
                    0x15B0;  // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_bCustomCubemapTexture = 0x15B8;  // bool
                constexpr std::ptrdiff_t m_hLightProbeTexture =
                    0x15C0;  // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_hLightProbeDirectLightIndicesTexture =
                    0x15C8;  // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_hLightProbeDirectLightScalarsTexture =
                    0x15D0;  // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_hLightProbeDirectLightShadowsTexture =
                    0x15D8;  // CStrongHandle<InfoForResourceTypeCTextureBase>
            ...
            namespace ActiveModelConfig_t {
                ...
                constexpr std::ptrdiff_t m_AssociatedEntities =
                    0x38;  // C_NetworkUtlVectorBase<CHandle<C_BaseModelEntity>>
                constexpr std::ptrdiff_t m_AssociatedEntityNames =
                    0x50;  // C_NetworkUtlVectorBase<CUtlSymbolLarge>
            }              // namespace ActiveModelConfig_t
            // Parent: C_CSWeaponBaseGun
            // Fields count: 0
            ...
            namespace C_BarnLight {
                ...
                constexpr std::ptrdiff_t m_QueuedLightStyleStrings =
                    0xD10;  // C_NetworkUtlVectorBase<CUtlString>
                constexpr std::ptrdiff_t m_LightStyleEvents =
                    0xD28;  // C_NetworkUtlVectorBase<CUtlString>
                constexpr std::ptrdiff_t m_LightStyleTargets =
                    0xD40;  // C_NetworkUtlVectorBase<CHandle<C_BaseModelEntity>>
                constexpr std::ptrdiff_t m_StyleEvent = 0xD58;  // CEntityIOOutput[4]
                constexpr std::ptrdiff_t m_hLightCookie =
                    0xDF8;  // CStrongHandle<InfoForResourceTypeCTextureBase>
            ...
            namespace C_EconEntity {
                ...
                constexpr std::ptrdiff_t m_hViewmodelAttachment =
                    0x1578;                                               // CHandle<CBaseAnimGraph>
                ...
                constexpr std::ptrdiff_t m_vecAttachedModels =
                    0x15A0;  // CUtlVector<C_EconEntity::AttachedModelData_t>
            }                // namespace C_EconEntity
            // Parent: C_CSWeaponBaseGun
            // Fields count: 0
            ...
            namespace C_ParticleSystem {
                ...
                constexpr std::ptrdiff_t m_iEffectIndex =
                    0xEE0;  // CStrongHandle<InfoForResourceTypeIParticleSystemDefinition>
            ...
            namespace C_EnvDecal {
                constexpr std::ptrdiff_t m_hDecalMaterial =
                    0xCD0;  // CStrongHandle<InfoForResourceTypeIMaterial2>
            ...
            namespace CModelState {
                constexpr std::ptrdiff_t m_hModel =
                    0xA0;  // CStrongHandle<InfoForResourceTypeCModel>
            ...
            namespace CAttributeList {
                constexpr std::ptrdiff_t m_Attributes =
                    0x8;  // C_UtlVectorEmbeddedNetworkVar<CEconItemAttribute>
            ...
            namespace CCSGameModeRules_ArmsRace {
                constexpr std::ptrdiff_t m_WeaponSequence =
                    0x38;  // C_NetworkUtlVectorBase<CUtlString>
            }
            // Parent: None
            // Fields count: 14
            //
            ...
            namespace CDamageRecord {
                ...
                constexpr std::ptrdiff_t m_hPlayerControllerRecipient =
            ...
            namespace CCSPlayerController_DamageServices {
                ...
                constexpr std::ptrdiff_t m_DamageList =
                    0x48;  // C_UtlVectorEmbeddedNetworkVar<CDamageRecord>
            }              // namespace CCSPlayerController_DamageServices
            // Parent: CEntityComponent
            // Fields count: 5
            ...
            namespace CLightComponent {
                ...
                constexpr std::ptrdiff_t m_hLightCookie =
                    0xB8;  // CStrongHandle<InfoForResourceTypeCTextureBase>
            ...
            namespace CBasePlayerVData {
                constexpr std::ptrdiff_t m_sModelName =
                    0x28;  // CResourceNameTyped<CWeakHandle<InfoForResourceTypeCModel>>
            ...
            namespace C_EnvParticleGlow {
                ...
                constexpr std::ptrdiff_t m_hTextureOverride =
                    0x1290;  // CStrongHandle<InfoForResourceTypeCTextureBase>
            }                // namespace C_EnvParticleGlow
            // Parent: C_CSGO_TeamPreviewCharacterPosition
            // Fields count: 0
            ...
            namespace CCSPlayerController_ActionTrackingServices {
                constexpr std::ptrdiff_t m_perRoundStats =
                    0x40;  // C_UtlVectorEmbeddedNetworkVar<CSPerRoundStats_t>
            ...
            namespace WeaponPurchaseTracker_t {
                constexpr std::ptrdiff_t m_weaponPurchases =
                    0x8;  // C_UtlVectorEmbeddedNetworkVar<WeaponPurchaseCount_t>
            }
            // Parent: None
            // Fields count: 5
            //
            ...
            namespace C_FuncLadder {
                ...
                constexpr std::ptrdiff_t m_Dismounts =
                    0xCE0;  // CUtlVector<CHandle<C_InfoLadderDismount>>
            ...
            namespace CPlayer_WeaponServices {
                constexpr std::ptrdiff_t m_hMyWeapons =
                    0x40;  // C_NetworkUtlVectorBase<CHandle<C_BasePlayerWeapon>>
            ...
            namespace C_EnvVolumetricFogController {
                ...
                constexpr std::ptrdiff_t m_hFogIndirectTexture =
                    0x5C0;  // CStrongHandle<InfoForResourceTypeCTextureBase>
            ...
            namespace CPrecipitationVData {
                constexpr std::ptrdiff_t m_szParticlePrecipitationEffect =
            ...
            namespace CCSPlayer_ActionTrackingServices {
                constexpr std::ptrdiff_t m_hLastWeaponBeforeC4AutoSwitch =
                    0x40;                                       // CHandle<C_BasePlayerWeapon>
                constexpr std::ptrdiff_t m_bIsRescuing = 0x44;  // bool
                constexpr std::ptrdiff_t m_weaponPurchasesThisMatch =
                    0x48;  // WeaponPurchaseTracker_t
                constexpr std::ptrdiff_t m_weaponPurchasesThisRound =
                    0xA0;  // WeaponPurchaseTracker_t
            }              // namespace CCSPlayer_ActionTrackingServices
            // Parent: None
            // Fields count: 12
            //
            ...
            namespace shard_model_desc_t {
                ...
                constexpr std::ptrdiff_t m_hMaterial =
                    0x10;  // CStrongHandle<InfoForResourceTypeIMaterial2>
                ...
                constexpr std::ptrdiff_t m_vecPanelVertices =
                    0x38;  // C_NetworkUtlVectorBase<Vector2D>
            ...
            namespace CPointTemplate {
                ...
                constexpr std::ptrdiff_t m_clientOnlyEntityBehavior =
                    0x598;  // PointTemplateClientOnlyEntityBehavior_t
                constexpr std::ptrdiff_t m_ownerSpawnGroupType =
                    0x59C;  // PointTemplateOwnerSpawnGroupType_t
                constexpr std::ptrdiff_t m_createdSpawnGroupHandles = 0x5A0;  // CUtlVector<uint32>
                constexpr std::ptrdiff_t m_SpawnedEntityHandles =
                    0x5B8;  // CUtlVector<CEntityHandle>
            ...
            namespace C_EnvCubemap {
                constexpr std::ptrdiff_t m_hCubemapTexture =
                    0x5D0;  // CStrongHandle<InfoForResourceTypeCTextureBase>
            ...
            namespace C_PointValueRemapper {
                ...
                constexpr std::ptrdiff_t m_hOutputEntities =
                    0x578;  // C_NetworkUtlVectorBase<CHandle<C_BaseEntity>>
            ...
            namespace CCSPlayer_BuyServices {
                constexpr std::ptrdiff_t m_vecSellbackPurchaseEntries =
                    0x40;  // C_UtlVectorEmbeddedNetworkVar<SellbackPurchaseEntry_t>
            }
            // Parent: C_BaseCSGrenade
            // Fields count: 0
            ...
            namespace C_EnvCubemapFog {
                ...
                constexpr std::ptrdiff_t m_hSkyMaterial =
                    0x580;  // CStrongHandle<InfoForResourceTypeIMaterial2>
                constexpr std::ptrdiff_t m_iszSkyEntity = 0x588;  // CUtlSymbolLarge
                constexpr std::ptrdiff_t m_hFogCubemapTexture =
                    0x590;  // CStrongHandle<InfoForResourceTypeCTextureBase>
            ...
            namespace CCollisionProperty {
                constexpr std::ptrdiff_t m_collisionAttribute =
                    0x10;                                            // VPhysicsCollisionAttribute_t
            ...
            namespace C_PlayerSprayDecal {
                ...
                constexpr std::ptrdiff_t m_SprayRenderHelper =
                    0xDB0;  // CPlayerSprayDecalRenderHelper
            }               // namespace C_PlayerSprayDecal
            // Parent: None
            // Fields count: 2
            //
            ...
            namespace C_BaseFlex {
                ...
                constexpr std::ptrdiff_t m_mEyeOcclusionRendererCameraToBoneTransform =
                    0xFC4;                                                           // matrix3x4_t
            ...
            namespace C_EnvSky {
                constexpr std::ptrdiff_t m_hSkyMaterial =
                    0xCD0;  // CStrongHandle<InfoForResourceTypeIMaterial2>
                constexpr std::ptrdiff_t m_hSkyMaterialLightingOnly =
                    0xCD8;  // CStrongHandle<InfoForResourceTypeIMaterial2>
            ...
            namespace CInfoOffscreenPanoramaTexture {
                ...
                constexpr std::ptrdiff_t m_TargetEntities =
                    0x570;  // C_NetworkUtlVectorBase<CHandle<C_BaseModelEntity>>
                constexpr std::ptrdiff_t m_nTargetChangeCount = 0x588;  // int32
                constexpr std::ptrdiff_t m_vecCSSClasses =
                    0x590;  // C_NetworkUtlVectorBase<CUtlSymbolLarge>
            ...
            namespace C_CSWeaponBase {
                ...
                constexpr std::ptrdiff_t m_ePlayerFireEventAttackType =
                    0x163C;                                            // WeaponAttackType_t
            ...
            namespace C_BreakableProp {
                ...
                constexpr std::ptrdiff_t m_OnHealthChanged =
                    0xF48;                                        // CEntityOutputTemplate<float32>
            ...
            namespace C_Beam {
                ...
                constexpr std::ptrdiff_t m_hBaseMaterial =
                    0xD08;  // CStrongHandle<InfoForResourceTypeIMaterial2>
                constexpr std::ptrdiff_t m_nHaloIndex =
                    0xD10;  // CStrongHandle<InfoForResourceTypeIMaterial2>
            ...
            namespace CCSWeaponBaseVData {
                ...
                constexpr std::ptrdiff_t m_szViewModel =
                    0x250;  // CResourceNameTyped<CWeakHandle<InfoForResourceTypeCModel>>
                constexpr std::ptrdiff_t m_szPlayerModel =
                    0x330;  // CResourceNameTyped<CWeakHandle<InfoForResourceTypeCModel>>
                constexpr std::ptrdiff_t m_szWorldDroppedModel =
                    0x410;  // CResourceNameTyped<CWeakHandle<InfoForResourceTypeCModel>>
                constexpr std::ptrdiff_t m_szAimsightLensMaskModel =
                    0x4F0;  // CResourceNameTyped<CWeakHandle<InfoForResourceTypeCModel>>
                constexpr std::ptrdiff_t m_szMagazineModel =
                    0x5D0;  // CResourceNameTyped<CWeakHandle<InfoForResourceTypeCModel>>
                constexpr std::ptrdiff_t m_szHeatEffect =
                    0x6B0;  // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
                constexpr std::ptrdiff_t m_szEjectBrassEffect =
                    0x790;  // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
                constexpr std::ptrdiff_t m_szMuzzleFlashParticleAlt =
                    0x870;  // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
                constexpr std::ptrdiff_t m_szMuzzleFlashThirdPersonParticle =
                    0x950;  // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
                constexpr std::ptrdiff_t m_szMuzzleFlashThirdPersonParticleAlt =
                    0xA30;  // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
                constexpr std::ptrdiff_t m_szTracerParticle =
                    0xB10;  // CResourceNameTyped<CWeakHandle<InfoForResourceTypeIParticleSystemDefinition>>
            ...
            namespace C_PointWorldText {
                ...
                constexpr std::ptrdiff_t m_nJustifyHorizontal =
                    0xF3C;  // PointWorldTextJustifyHorizontal_t
                constexpr std::ptrdiff_t m_nJustifyVertical =
                    0xF40;  // PointWorldTextJustifyVertical_t
            ...
            // NetworkVarNames: m_pActionTrackingServices
            // (CCSPlayerController_ActionTrackingServices*) NetworkVarNames: m_pDamageServices
            // (CCSPlayerController_DamageServices*) NetworkVarNames: m_iPing (uint32)
            ...
            namespace CCSPlayerController {
                constexpr std::ptrdiff_t m_pInGameMoneyServices =
                    0x6F8;  // CCSPlayerController_InGameMoneyServices*
                constexpr std::ptrdiff_t m_pInventoryServices =
                    0x700;  // CCSPlayerController_InventoryServices*
                constexpr std::ptrdiff_t m_pActionTrackingServices =
                    0x708;  // CCSPlayerController_ActionTrackingServices*
                constexpr std::ptrdiff_t m_pDamageServices =
                    0x710;                                 // CCSPlayerController_DamageServices*
                ...
                constexpr std::ptrdiff_t m_hOriginalControllerOfCurrentPawn =
                    0x808;                                  // CHandle<CCSPlayerController>
                constexpr std::ptrdiff_t m_iScore = 0x80C;  // int32
                constexpr std::ptrdiff_t m_vecKills =
                    0x810;  // C_NetworkUtlVectorBase<EKillTypes_t>
            ...
            namespace C_PhysMagnet {
                ...
                constexpr std::ptrdiff_t m_aAttachedObjects =
                    0xEF0;  // CUtlVector<CHandle<C_BaseEntity>>
            }               // namespace C_PhysMagnet
            // Parent: C_BaseModelEntity
            // Fields count: 8
            //
            ...
            namespace C_FuncConveyor {
                ...
                constexpr std::ptrdiff_t m_hConveyorModels =
                    0xCF8;  // C_NetworkUtlVectorBase<CHandle<C_BaseEntity>>
            ...
            namespace CGameSceneNode {
                ...
                constexpr std::ptrdiff_t m_vecOrigin =
                    0x80;  // CNetworkOriginCellCoordQuantizedVector
                ...
                constexpr std::ptrdiff_t m_nDoNotSetAnimTimeInInvalidatePhysicsCount =
                    0xED;                                                // uint8
            ...
            // NetworkVarNames: m_flHDRColorScale (float32)
            namespace C_Sprite {
                constexpr std::ptrdiff_t m_hSpriteMaterial =
                    0xCE8;  // CStrongHandle<InfoForResourceTypeIMaterial2>
                ...
                constexpr std::ptrdiff_t m_hOldSpriteMaterial =
                    0xD50;  // CWeakHandle<InfoForResourceTypeIMaterial2>
